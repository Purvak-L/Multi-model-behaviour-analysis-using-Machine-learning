...
<body>
    ...
    <legend>welcome <?php echo $_SESSION['name']; ?></legend>
	 <input type="hidden" name="test" value="Section D">
...
initializeClock('clockdiv', deadline);
	...
	<center><h2>IA Test</center></h2>
			...
			<input type="text" name="question1" value="1.Level 2">
...
<script type="text/javascript">
    setTimeout(function () {
   window.location.href= 'sectionE.php'; // the redirect goes here
},300000); 
alert(time)// 5 sec
</script>
...
$('input[name=option_selected1]').click(function() {
 ...
 // $('#clicked').text(count5); // update text
		...
		<input type="hidden" name="qno1" value="Q2M">
			<input type="text" name="question2" value="2.Level 2">
...
$('input[name=option_selected2]').click(function() {
  ...
  count1++
	...
	// window.alert(count1);
			...
			<input type="text" name="question3" value="3.Level 2">
...
$('input[name=option_selected3]').click(function() {
  count2++
	...
	//window.alert(count2);
			...
			<input type="text" name="question4" value="4.Level 2">
...
$('input[name=option_selected4]').click(function() {
  ...
  count3++
	...
	//window.alert(count3);
			...
			<input type="text" name="question5" value="5.Level 2">
...
$('input[name=option_selected5]').click(function() {
  ...
  count4++
	...
	//window.alert(count4);
			...
			<input type="text" name="question6" value="6. Level 2">
