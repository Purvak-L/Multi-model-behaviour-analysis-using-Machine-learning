...
<body>
    ...
    <legend>welcome <?php echo $_SESSION['name']; ?></legend>
	 <input type="hidden" name="test" value="Section E">
...
<script type="text/javascript">
    setTimeout(function () {
   window.location.href= 'result_display.php'; // the redirect goes here
},300000); 
alert(time)// 5 sec
</script>
...
$('input[name=option_selected1]').click(function() {
 ...
 // $('#clicked').text(count5); // update text
		...
		<div>
		<input type="hidden" name="qno1" value="Q2D">
...
$('input[name=option_selected3]').click(function() {
  count2++
	...
	//window.alert(count2);
			...
			<div>
			<input type="hidden" name="qno3" value="Q4D">
...
$('input[name=option_selected5]').click(function() {
  ...
  count4++
	...
	//window.alert(count4);
			...
			<div>
			<input type="hidden" name="qno6" value="Q6M">
			<input type="text" name="question6" value="6. Q6 ?">
...
$('input[name=option_selected6]').click(function() {
  ...
  count6++
			...
			<center><div oninput="x.value=parseInt(a.value)">
		<legend>Rate confusion level while undergoing test</legend> </center>
			Min
		<input type="range" id="conf" name="conf" value="5" min="0" max="10">
			Max
		<br><br>
