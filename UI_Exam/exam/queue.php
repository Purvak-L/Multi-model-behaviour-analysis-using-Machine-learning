...
initializeClock('clockdiv', deadline);
	...
	<center><h2>Queue Test</center></h2>
			...
			<input type="text" name="question1" value="1.On which principle does queue work?">
   ...
   if(count5=="3")
	...
	if(count5=="1")
	{
		...
		<input type="hidden" name="qno1" value="Q2">
			<input type="text" name="question1" value="2.Which of the following is not the type of queue?">
   ...
   if(count1=="3")
	...
	if(count1=="1")
	{
		document.getElementById('add1').value= "confident";  
			...
			<input type="text" name="question1" value="3.New nodes are added to the the queue.">
   ...
   if(count2=="3")
	...
	if(count2=="1")
	{
		document.getElementById('add2').value = "confident";  
			...
			<input type="text" name="question1" value="4.____ is a operation not performed in Queue?">
   ...
   if(count3=="3")
	...
	if(count3=="1")
	{
		document.getElementById('add3').value = "confident";  
			...
			<input type="text" name="question1" value="5.Linear arrays are also called ?">
